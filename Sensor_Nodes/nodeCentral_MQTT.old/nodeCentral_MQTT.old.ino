...
const char* broker = "host.iotp.mqtt.bluemix.com";

const char* DeviceId = "central-1"; 
const char* ThingspeakUser = "use-token-auth";               // Can be any name.
const char* ThingspeakPass = "KEKvrs!WDj36sgvP1a";        // Change this your MQTT API Key from Account > MyProfile.

char* topic = "channels/419812/publish/fields/field1/X1H7B6RD67MHVGIZ";
