...
#define IDCOLMEIA 4                                             // ID of the Hive monitored
#define TEMPO_ENTRE_CADA_LEITURA 36                             // Time between each reading in seconds  
#define SENSOR "Sensor 4"                                       // Name of the sensor
