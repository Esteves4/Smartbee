...
def receive_data(network_obj):
    ...
    Keyword arguments:
        network_obj -- The object of the RF24Network class
...
def set_rasp_timestamp(gsm_client, network_apn, networ_user, networ_password):
    if not connection_gsm(gsm_client, network_apn, networ_user, networ_password):
        return False
